...
@section('heading')
    {{ __('Create new parking for site') }}
@endsection
...
@section('navlink')
    ...
    <li class="breadcrumb-item active" aria-current="page">Create parking</li>
@endsection
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">{{ __('Create parking') }} </h4>
                        </div>
                        <div class="card-content">
                            <div class="card-body">

                                <form method="post"  enctype="multipart/form-data" class="form" action="{{ route('acp.parking.created') }}">
